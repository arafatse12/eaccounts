...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <?php  $paymentsAll=$this->db->query("select * from db_installment_payments where sale_id='$sales_id' limit 1"); ?>
      <div class="row no-print">
        ...
        <?php if($CI->permissions('sales_return_add')) { ?>
          ...
          <?php } ?>
          <?php foreach ($paymentsAll->result() as $key => $payment) {
          ?>
          <a href="<?php echo $base_url; ?>sales/installment_pdf/<?php echo  $sales_id ?>" target="_blank" class="btn btn-primary">
            <i class="fa fa-file-pdf-o"></i> 
            Installment Invoice
        </a>
        <?php }
