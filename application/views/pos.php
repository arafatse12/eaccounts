          ...
          <div class="box box-primary">
            ...
            <?php } ?>
              ...
              <div class="row">
                ...
                <?php
                    $sales = $this->db->query("select * from db_sales where id=$sales_id");
                    $months= $this->db->query("select * from db_installment_month");
                    $sales_type=$this->db->query("select sales_type from db_sales where id='$sales_id'")->row()->sales_type;
                  ?>
                <div class="row">
                  <div class="col-md-6">
                      <div class="">
                        <label for="sale_type"> Sale Type </label>
                            <select class="form-control select2" id='sale_type' name="sale_type" onchange="installmentChange();">
                                <?php
                                    ...
                                    if($sales_type==1){
                                      ...
                                      echo "<option value='3' >Haier Sale</option>";
                                    }else if($sales_type==2){
                                      $selected= 'selected';
                                      echo "<option value=''>--Select--</option>";
                                      echo "<option value='1' >Cash</option>";
                                      echo "<option value='2' $selected>Credit</option>";
                                      echo "<option value='3' >Haier Sale</option>";
                                      ...
                                      echo "<option value='1' >Cash</option>";
                                      echo "<option value='2'>Credit</option>";
                                      echo "<option value='3'  $selected>Haier Sale</option>";
                                    }else {
                                      $selected= '';
                                      echo "<option value=''>--Select--</option>";
                                      echo "<option value='1' >Cash</option>";
                            ...
                            <span id="sale_type_msg" style="display:none" class="text-danger"></span>
                      </div>
                  </div>
                  <div class="col-md-6" id="amountId">
		                  <div class="">
                        <label for="amount">Down Amount</label>
              ...
              <div class="row">
                      <div class="col-md-4" id="installmentType" >
                          <div class="">
                            <label for="installment_type"><?= 'Installment Type' ?></label>
                            <select class="form-control" id='installment_type' name="installment_type">
                              <?php
                                  echo "<option value=''> --No Installment-- </option>";
                                      foreach($months->result() as $res1){
                                      if($res1->month==$installment_payment_month){
                                        $selected= 'selected';
                                      }else{
                                        $selected= '';
                                      }
                                      echo "<option $selected value='".$res1->month."'>".$res1->month ." ".'Month'."</option>";
                                    }
                                ?>
                            </select>
                            <span id="installment_type_msg" style="display:none" class="text-danger"></span>
                          </div>
                    </div>
                    <div class="col-md-4" id="installmentType1">
                          <div class="">
                              ...
                              <?php
                                $q1=$this->db->query("select * from db_paymenttypes where status=1");
                                  if($q1->num_rows()>0){
                                    echo "<option value=''>-Select-</option>";
                                      foreach($q1->result() as $res1){
                                    $selected=($res1->payment_type=='Cash') ? 'selected' : '';
                    ...
                    <div class="col-md-4" id="insRate">
                        <div class="">
                        <label for="interest_rate"><?= 'Interest Rate % '; ?></label>
                          <input type="text" class="form-control text-right" id="interest_rate" name="interest_rate" placeholder="" onkeyup="final_total();">
                          <input type="hidden" class="form-control text-right" id="interest_rate_value" name="interest_rate_value" >
                            <span id="interest_rate_msg" style="display:none" class="text-danger"></span>
                      </div>
                    </div>
                   
              </div>
              <div class="row">
              <div class="col-md-12" id="paymenyId">
                                          <table class="table table-hover table-bordered" style="width:100%" id="installment_payment"><h4 class="box-title text-info"><?= 'Installment Payment' ?> : </h4>
                                             <thead>
                                                <tr class="bg-gray " >
                                                   <th>Schedule No</th>
              ...
              <div class="box-footer bg-gray">
                <div class="row" id="normalSaleRow">
                ...
                <div class="row" id="heireSaleRow">
                  ...
                  <div class="col-md-2 text-right">
                          ...
                          <?= $CI->currency('<span style="font-size: 19px;" class="tot_int_amount text-bold"></span>');?>
                  </div>
                  <div class="col-md-3 text-right">
                          <label><?= $this->lang->line('grand_total'); ?>:</label><br>
                          <?= $CI->currency('<span style="font-size: 19px;" class="tot_grand text-bold"></span>');?>
                ...
                <div class="row" id="savePayment">
                  <div class="col-md-12 text-center">
                      <button id="saveButton" type="button" class="btn bg-maroon btn-lg make_sale btn-lg" onclick="save()"><i class="fa  fa-save "></i> Save</button>
                  </div>
...
<script>
   var q_id = $("#sales_id").val();
   var sale_type =$("#sale_type").val();
      if(sale_type==3){
        $("#normalSaleRow").addClass("hide");
        $("#heireSaleRow").removeClass("hide");
        $("#savePayment").removeClass("hide");
        $("#paymentButton").addClass("hide");
        $("#amountId").removeClass("hide");
        $("#installmentType").removeClass("hide");
        $("#installmentType1").removeClass("hide");
        $("#insRate").removeClass("hide");

      }else if(sale_type!==3){
        $("#normalSaleRow").removeClass("hide");
        $("#heireSaleRow").addClass("hide");
        $("#savePayment").addClass("hide");
        $("#paymentButton").removeClass("hide");
        $("#amountId").addClass("hide");
        $("#installmentType").addClass("hide");
        $("#installmentType1").addClass("hide");
        $("#insRate").addClass("hide");
...
function final_total(){
  ...
  var interest_rate=$("#interest_rate").val();
    ...
    interest_rate = interest_rate;
      ...
      interest_rate=$("#interest_rate").val(0);
    }
  ...
  var interest_rate=parseFloat($("#interest_rate").val());
             var amount =total;
             var interest_rates = 0;
            if(interest_rate >0){
               var interest_rate=$("#interest_rate").val();
               var paid_amt=$(".paid_amt").val();
                var amount =total;
               interest_rates=(((amount-paid_amt)*interest_rate)/100);
            }
              
  total+=other_charges;
  total =round_off(total+interest_rates);
  $(".tot_int_amount").html(interest_rates);
  $("#interest_rate_value").val(interest_rates);
  var discount_amt=0;
  if(total>0){
  ...
  set_total(item_qty,total-interest_rates,discount_amt,total-discount_amt);
}
