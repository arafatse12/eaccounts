...
<div class="wrapper">
  ...
  <?php 
    ...
    $branch_id  = $this->session->userdata('branch_id');
      $total_invoice=$this->db->query("SELECT COUNT(*) as total FROM db_sales where branch_id='$branch_id'")->row()->total;
      /*Total Invoices Total*/
      $sal_total=$this->db->query("SELECT COALESCE(sum(grand_total),0) AS tot_sal_grand_total FROM db_sales where branch_id='$branch_id'")->row()->tot_sal_grand_total;

      /*PAID AMOUNT*/
      $tot_received_amt=$this->db->select("COALESCE(SUM(paid_amount),0) AS paid_amount")->from("db_sales")->where("branch_id='$branch_id'")->get()->row()->paid_amount;
  ...
  <div class="content-wrapper">
    ...
    <div class="installment_pay_now_modal">
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?= $CI->currency($sal_total-$tot_received_amt,$with_comma=true);?></h3>
