 ...
 <?php
   $branch_id  = $this->session->userdata('branch_id');
    if(!isset($purchase_id)){
      ...
      $q2 = $this->db->query("select * from db_purchase where branch_id='$branch_id' and id=$purchase_id");
      ...
      $items_count = $this->db->query("select count(*) as items_count from db_purchaseitems where branch_id='$branch_id' and purchase_id=$purchase_id")->row()->items_count;
    }
                                        ...
                                        <div class="col-md-12">
                                          <table class="table table-hover table-bordered" style="width:100%" id="payments_table"><h4 class="box-title text-info"><?= $this->lang->line('previous_payments_information'); ?> : </h4>
                                             ...
                                             <tbody>
                                                <?php 
                                                  if(isset($purchase_id)){
                                                    $q3 = $this->db->query("select * from db_purchasepayments where branch_id='$branch_id' and purchase_id=$purchase_id");
                                                    if($q3->num_rows()>0){
                                                      $i=1;
                                                      $total_paid = 0;
