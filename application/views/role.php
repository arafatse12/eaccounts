                                      ...
                                      <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="installment_month"> <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[brand]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="installment_month_all" id='installment_month_add' name="permission[installment_month_add]"> <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="installment_month_all" id='installment_month_edit' name="permission[installment_month_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="installment_month_all" id='installment_month_delete' name="permission[installment_month_delete]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="installment_month_all" id='installment_month_view' name="permission[installment_month_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!--COMPANY PROFILE  -->
