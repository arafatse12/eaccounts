...
<div class="wrapper">
 ...
 <?php
    if(!isset($sales_id)){
      ...
      $sales_type=$q2->row()->sales_type;

      $items_count = $this->db->query("select count(*) as items_count from db_salesitems where sales_id=$sales_id")->row()->items_count;
    }
    

    $installment = $this->db->query("select * from db_installment_payments where sale_id=$sales_id");
    if($installment){
      $installment_payment_month= $installment->row()->installment_payment_month;
    }else{
               ...
               <!-- ********** ALERT MESSAGE END******* -->
                  ...
                  <span id="reference_no_msg" style="display:none" class="text-danger"></span>
                           ...
                           <div class="row">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <table  class="col-md-9">
                                             ...
                                             <tr>
                                                <th class="text-right" style="font-size: 17px;"><?= 'Interest Amount' ?></th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4><b id="interest_rate_amt" name="interest_rate_amt">0.00</b></h4>
                                                </th>
                                             </tr>
                              ...
                              <div class="col-xs-12 ">
                                 <div class="col-sm-12">
                                       <div class="box-body ">
                                                      ...
                                                      <select class="form-control select2" id='sale_type' name="sale_type" onchange="installmentChange();">
                                                         <?php
                                                            if($sales_type) {
                                                               ...
                                                               echo "<option value=''>-Select-</option>";
                                                               echo "<option value='1' $sales_type>Cash</option>";
                                                               echo "<option value='2' $sales_type>Credit</option>";
                                                               echo "<option value='3' $sales_type>Haier Sale</option>";
                                                         ?>
                                                      </select>
                                        ...
                                        <div class="col-md-6">
                                             <div class="">
                                                <label for="amount" id="down"> Down Payment </label>
                                                <label for="amount" id="amountPay"> Amount </label>
                                                   <input type="text" class="form-control text-right paid_amt only_currency" id="amount" name="amount" placeholder="" onkeyup="final_total();">
                                                   <span id="amount_msg" style="display:none" class="text-danger"></span>
                                             </div>
                                       </div>
                                       <?php  $months= $this->db->query("select * from db_installment_month"); ?>
                                        <div class="col-md-6" id="installmentType" >
                                                  <div class="">
                                        ...
                                        <div class="row">
                                             <div class="col-md-6 hide" id="insRate">
                                                  <div class="">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <table  class="col-md-6">
                                             ...
                                             <tr>
                                                <th class="text-right" style="font-size: 17px;">Paid Amount</th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4><b id="paid_amount" name="paid_amount">0.00</b></h4>
                                                </th>
                                             </tr>
                                             <tr>
                                                <th class="text-right" style="font-size: 17px;">Invoice Due</th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4><b id="due_invoice" name="due_invoice">0.00</b></h4>
                                                </th>
                                             </tr>
                                          </table>
                                       </div>
                              ...
                              <div class="col-xs-12" id="paymenyId">
                                 <div class="col-sm-12">
                                       <div class="box-body ">
                                        <div class="col-md-12">
                           ...
                           <!-- /.box-body -->
                           <div class="box-footer col-sm-12" id="saveId">
                              <center>
                                <?php
                                if(isset($sales_id)){
                                  $btn_id='update';
...
<!-- ./wrapper -->
      ...
      <script>
         ...
         if(q_id==undefined){
            $("#installmentType").css("display", "none");
         }
         $("#amountPay").show();
         $("#down").hide();
        ...
        /*function set_to_original(i,purchase_price) {
         ...
         function installmentChange(){
            ...
            if(sale_type==3){
               ...
               $("#installmentType").css("display", "block");
               $("#amountPay").hide();
               $("#down").show();
            }else{
          ...
          //Show total Sales Quantitys
           ...
           if((subtotal!=null || subtotal!='') && (subtotal!=0)){
            ...
            if(interest_rate >0){
               ...
               interest_rates=((taxable-amount)*interest_rate)/100;
            }

            $("#interest_rate_amt").html(parseFloat(interest_rates).toFixed(2)); 
             subtotal_round=round_off(taxable)+interest_rates;//round_off() method custom defined
             ...
             $("#due_invoice").html(parseFloat(subtotal_round).toFixed(2)-amount); 
             ...
             $("#subtotal_amt").html('0.00'); 
             $("#other_charges_amt").html('0.00');  
             $("#interest_rate").html('0.00');  
             $("#interest_rate_amt").html('0.00');  
