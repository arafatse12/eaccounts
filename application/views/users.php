                     ...
                     <div class="box box-info ">
                        ...
                        <!-- form start -->
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                                 <label for="user_type" class="col-sm-4 control-label">Branch<label class="text-danger">*</label> </label>
                                 <div class="col-sm-8">
                                    <select class="form-control" <?=$disabled;?> id="branch_id" name="branch_id"  style="width: 100%;">
                                       <?php
                                       $q2 = $this->db->select("*")->get("db_branch");
                                          if($q_id){
                                             $branch_id = $this->db->select("branch_id")->where("id",$q_id)->get('db_users')->row()->branch_id;
                                          }
                                          if($q2->num_rows()>0)
                                           {
                                            echo "<option value=''>-Select-</option>";
                                    ...
                                    <span id="user_type_msg" style="display:none" class="text-danger"></span>
                                 </div>
                              </div>
                              <div class="form-group">
