        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>installment_month/new">
                <i class="fa fa-plus"></i> Installment Month New </a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tbody>
					<?php
					      $i=1;
                  $qs1="select id,month from db_installment_month order by id desc";
            ...
            ?>
						<tr>
                            ...
                            <td class="text-center"> <?php echo $res1->month;?> </td>
                            ...
                            <td>
                                <div class="btn-group" title="View Account">
                                    ...
                                    <li>
                                        <a title="Update Record ?" href="<?= $base_url; ?>installment_month/edit/<?= $res1->id; ?>">
                                        <i class="fa fa-fw fa-edit text-blue"></i>Edit
                                        </a>
                                    </li>
                                    <li>
                                        <a style="cursor:pointer" title="Delete Record ?" onclick="delete_installment_month(<?= $res1->id; ?>)">
