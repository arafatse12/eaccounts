...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= $this->lang->line('branch_list') ?>
        <small>Add/Update Branch</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><?= $this->lang->line('branch_list'); ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>branchs/new">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tbody>
					<?php
					      $i=1;
                  $qs1="select id,name from db_branch order by id desc";
						...
						<tr>
                            ...
                            <td>
                                <div class="btn-group" title="View Account">
                                    ...
                                    <li>
                                        <a title="Update Record ?" href="<?= $base_url; ?>branchs/edit/<?= $res1->id; ?>">
                                        <i class="fa fa-fw fa-edit text-blue"></i>Edit
                                        </a>
                                    </li>
                                    <li>
                                        <a style="cursor:pointer" title="Delete Record ?" onclick="delete_branch(<?= $res1->id; ?>)">
