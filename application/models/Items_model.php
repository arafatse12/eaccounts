...
class Items_model extends CI_Model {
	...
	public function stock_entry($entry_date,$item_id,$qty='0',$note=''){
		$branch_id  = $this->session->userdata('branch_id');
		$q1=$this->db->query("insert into db_stockentry(entry_date,item_id,branch_id,qty,status,note) values('$entry_date',$item_id,$branch_id,$qty,1,'$note')");
		if(!$q1){
			return false;
		}
		else{
	...
	public function verify_and_save(){
		...
		$branch_id  = $this->session->userdata('branch_id');
		$query1="insert into db_items(branch_id,description,item_code,item_name,brand_id,category_id,sku,hsn,unit_id,alert_qty,lot_number,expire_date,
							...
							values('$branch_id','$description','$item_code','$item_name','$brand_id','$category_id','$sku','$hsn','$unit_id','$alert_qty','$lot_number','$expire_date',
									'$price','$tax_id','$purchase_price','$tax_type',$profit_margin,
									'$sales_price','$custom_barcode','$final_price',
