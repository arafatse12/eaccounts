...
class Login_model extends CI_Model
{
	...
	public function verify_credentials($username,$password)
	{
		...
		$query=$this->db->query("select a.id,a.username,a.role_id,b.role_name,a.branch_id from db_users a, db_roles b where b.id=a.role_id and  a.username='$username' and a.password='".md5($password)."' and a.status=1");
		if($query->num_rows()==1){
